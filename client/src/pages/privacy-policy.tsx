    ...
    <div style={{ backgroundColor: 'var(--color-background)', minHeight: '100vh' }}>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-sm max-w-none" style={{ color: 'var(--color-secondary)' }}>
          ...
          <p className="mb-6">
            {productName} ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when you use our web application and related
          ...
          <p className="mb-4">
            When you create an account, we collect your name, email address, and the business name and location(s) you
            associate with your account. If you are invited by a business owner, your profile is created with the
            information they provide.
          </p>
          <p className="mb-2 font-semibold">Business Data</p>
          <p className="mb-4">
            The Service stores operational data you enter, including but not limited to: recipes, ingredient costs, tip
            distributions, cash deposit records, equipment logs, task assignments, employee schedules, financial
            budgets, and documents you upload.
          </p>
          <p className="mb-2 font-semibold">Third-Party Integrations</p>
          <p className="mb-4">
            If you connect third-party services (e.g., QuickBooks Online, Stripe), we receive tokens and account
            identifiers necessary to access your data on those platforms. We store OAuth tokens securely and only access
            the scopes you authorize.
          </p>
          <p className="mb-2 font-semibold">Usage Data</p>
          <p className="mb-6">
            We automatically collect technical information such as browser type, device type, IP address, pages visited,
            and timestamps to improve the Service and diagnose issues.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-1">
            <li>
              <strong>Service providers</strong> — hosting (GitHub/Supabase), payment processing (Stripe), email
              delivery (Resend), and file storage providers that help us operate the Service
            </li>
            <li>
              <strong>Third-party integrations</strong> — only the platforms you explicitly connect (e.g., QuickBooks
              Online), and only with the data scopes you authorize
            </li>
            <li>
          ...
          <p className="mb-6">
            We use industry-standard security measures including encrypted connections (TLS), row-level security to
            isolate tenant data, role-based access controls, and secure token storage. While we strive to protect your
            data, no method of electronic transmission or storage is 100% secure.
          </p>
          ...
          <p className="mb-6">
            ...
            your account, we will delete or anonymize your data within 90 days, except where retention is required by
            law.
          </p>
          ...
          <p className="mb-6">
            The Service uses essential cookies and local storage for authentication and session management. We do not
          ...
          <p className="mb-6">
            ...
            updated policy on this page and updating the effective date. Your continued use of the Service after changes
